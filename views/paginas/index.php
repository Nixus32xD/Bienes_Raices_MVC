<main class="contenedor seccion">
   <?php  debuguear("Saludando desde el index"); ?>
    ...
    <section class="imagen-contacto" data-cy="imagen-contacto">
        ...
        <p>Llena el formulario de contacto y un asesor se pondra en contacto contico a la brevedad</p>
        <a href="/contacto" class="boton-amarillo">Contactanós</a>
    </section>
            ...
            <article class="entrada-blog">
                ...
                <div class="texto-entrada">
                    <a href="entrada.php">
                        ...
                        <p class="informacion-meta">Escrito el: <span>03/03/2022</span> por: <span>Admin</span></p>
                        <p>
